...
def driver_1() -> Driver:
    return Driver(
        id_=1, first_name="Jon", last_name="Smith", registration_number="ABC123"
    )
...
def driver_2() -> Driver:
    return Driver(
        id_=2, first_name="Bob", last_name="Doe", registration_number="XYZ123"
    )
...
def popular_speed_camera_data_dict_1() -> PopularSpeedCameraDict:
    return {"location": "Warshaw", "total_count": 5}


@pytest.fixture
def popular_speed_camera_data_dict_2() -> PopularSpeedCameraDict:
    return {"location": "Krakow", "total_count": 3}


@pytest.fixture
def top_driver_data_dict_1() -> TopDriverDict:
    return {"first_name": "John", "last_name": "Doe", "total_points": 7}
